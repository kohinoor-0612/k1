...
let source0 = Game.spawns['Spawn1'].room.find(FIND_SOURCES)[0].energy;
let source1 = creep.room.find(FIND_SOURCES)[1].energy;


Game.spawns['Spawn1'].room.find(FIND_SOURCES)[0]

Game.rooms['sim'].getTerrain()

Game.rooms['sim'].getTerrain().get(10, 10)

Game.rooms['sim'].getTerrain().get(10, 10)


Game.spawns['Spawn1'].room.memory.resvount == '2'